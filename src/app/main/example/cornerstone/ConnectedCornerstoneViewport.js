...
const mapStateToProps = (state, ownProps) => {
	...
	const isActive = viewportIndex === state['rootReducer'].viewports.activeViewportIndex;
	const viewportSpecificData = state['rootReducer'].viewports.viewportSpecificData[viewportIndex] || {};
