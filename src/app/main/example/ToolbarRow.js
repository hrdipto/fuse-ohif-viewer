...
import toolbarModule from './vtkExtension/src/toolbarModule.js';
import { ToolbarButton } from './ui/src/viewer/ToolbarButton';
import ExpandableToolMenu from './ui/src/viewer/ExpandableToolMenu.js';
...
class ToolbarRow extends Component {
	...
	constructor(props) {
		...
		// console.log(this.state.toolbarButtons)
	...
	updateButtonGroups() {
		...
		panelModules.forEach(panelExtension => {
			...
			panelModule.menuOptions.forEach(menuOption => {
				...
				const isDisabled =
					typeof menuOption.isDisabled === 'function' && menuOption.isDisabled(this.props.studies);
...
function _getButtonComponents(toolbarButtons, activeButtons) {
	...
	return toolbarButtons.map(button => {
		...
		if (hasCustomComponent) {
			console.log(hasCustomComponent);
...
function _getVisibleToolbarButtons() {
	...
	toolbarModules.forEach(extension => {
		...
		definitions.forEach(definition => {
			...
			// console.log(this.props.activeContexts)
			// this.props.activeContexts.push('ACTIVE_VIEWPORT::CORNERSTONE')
			if (this.props.activeContexts.includes(context)) {
				toolbarButtonDefinitions.push(definition);
			}
		});
	});
	// toolbarModule.forEach(extension => {
	const { definitions, defaultContext } = toolbarModule;
	definitions.forEach(definition => {
		const context = definition.context || defaultContext;
		// console.log(this.props.activeContexts)
		// this.props.activeContexts.push('ACTIVE_VIEWPORT::CORNERSTONE')
	...
	// });
	// toolbarButtonDefinitions = toolbarButtonDefinitions.concat(toolbarModule)
	console.log(toolbarButtonDefinitions);
...
export default withTranslation(['Common', 'ViewportDownloadForm'])(withAppContext(ToolbarRow));
